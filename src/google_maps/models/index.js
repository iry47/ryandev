...
const db = {};
const sequelize = new Sequelize("ryandev", "ryandev", "ryandev", "ryandev"); // creation of the obj sequelize --> making the connection with the config

const folderModels = ["Map"];
